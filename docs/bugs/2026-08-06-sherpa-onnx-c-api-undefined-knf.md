...
**Reported from:** `gtk-speechtotext-poc` Vala stdout PoC  
...
✔️ `./build/stt-poc` → prints `Listening … Model: models/sherpa-onnx-nemotron-…` (no symbol lookup error; Ctrl+C / timeout exits cleanly)
